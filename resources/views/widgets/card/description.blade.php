<div class="row">
	<div class="col-sm-12 " id="row-task-edit">
    	<div id="description" style="display: none;">
    		<h4 class="title" ><i class="fa fa-file-text-o"></i>
            @if(isset($descriptionTitle)) {{ $descriptionTitle }} 
            @else @lang('task.title_description') 
            @endif
            </h4><a href="javascript:void(0)" id="btn_edit_description_body" >@lang('task.btn_edit')</a>
    	...
    	<div class="task-edit-description" style="display: none;">
            ...
            <div id="task-edit-description-body" >
            	<textarea class="form-control" rows="3" id="task-description" placeholder=" @if(isset($descriptionTitle)) {{ $descriptionTitle }} 
                @else @lang('task.title_description') 
                @endif" style="overflow:auto;"></textarea>
            	<BR>
