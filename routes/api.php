...
Route::get('/server-url', 'API\HomeController@serverUrl') ;
Route::post('/check_app_update_status', 'API\HomeController@check_app_update_status') ;

Route::group(['middleware'=> ['apiserver'] ], function () {
    ...
    Route::get('/signin', 'API\User\LoginController@signin') ;
    ...
    Route::group(['prefix'=>'/search'], function () {
        ...
        Route::get('/province', 'API\SearchController@getProvince');
    ...
    Route::get('/search/domain', 'API\SearchController@domain');
    ...
    Route::group(['middleware'=> ['auth:api'] ], function () {
        ...
        Route::put('/domain/{domain_id}', 'API\User\DomainController@update') ;
        Route::delete('/domain/{domain_id}', 'API\User\DomainController@destroy') ;
        ...
        Route::group(['prefix'=>'/profile'], function () {
            ...
            Route::put('/facebook', 'API\User\ProfileController@facebook') ;
            Route::put('/unlinkfacebook', 'API\User\ProfileController@unlinkfacebook') ;
            Route::put('/username', 'API\User\ProfileController@username') ;
    ...
    Route::group(['prefix'=>'master'], function () {
        ...
        Route::get('/debt-type', 'API\MasterController@debtType') ;
        Route::get('/title-name', 'API\MasterController@titleName') ;
    });
    ...
    Route::group(['prefix'=>'/{domain}','middleware'=>['auth:api'] ], function () {
        Route::resource('/important_day_manage', 'API\ImportantDay\ImportantDayController');	
		Route::get('/important_day', 'API\ImportantDay\ImportantDayController@getForMobile');
        Route::group(['prefix'=>'/master','namespace'=>'API\Master'], function () {
            ...
            Route::resource('esticker', 'EstickerController');
        ...
        Route::group(['prefix'=>'/channel'], function () {
            ...
            Route::post('/blacklist', 'API\Main\ChannelController@blackListCreate');
            Route::get('/blacklist', 'API\Main\ChannelController@blackListGet');
            Route::delete('/blacklist/{blacklist_id}', 'API\Main\ChannelController@blackListDelete');
            
            Route::post('/blacklist/inform', 'API\Main\ChannelController@blackListInform');
            ...
            Route::put('/message/{message_id}/hide', 'API\Main\ChannelController@hideMessage');
            // Route::put('/message/{message_id}/unpin', 'API\Main\ChannelController@unpinMessage');
        ...
        Route::get('/remove-user', 'API\Admin\RemoveUserController@index');
        ...
        // });
        Route::delete('/rooms/{room_id}/{id_card}', 'API\User\RoomController@removeUser');
        ...
        Route::get('/parking/{room_id}/checkin', 'API\Parking\UseController@getCheckIn');
        Route::post('/parking/search/checkin', 'API\Parking\UseController@searchCheckIn');
        Route::resource('/guard/parking-in', 'API\Parking\GuardInController');
        ...
        Route::group(['prefix'=>'/parking','namespace'=>'API\Parking'], function () {
            ...
            Route::post('/guard/not-in-system', 'GuardController@notInSystem');
            Route::resource('/guard', 'GuardController');
            Route::resource('/package', 'PackageController');
            Route::resource('/buy', 'BuyController');
            Route::get('/{room_id}/use/package', 'UseController@getPackage');

            Route::post('/{room_id}/use/check-debt-hour', 'UseController@checkDebtHour');
            ...
            Route::resource('/manual-in', 'ManualInController');
            Route::resource('/manual-out', 'ManualOutController');
        });
        ...
        Route::get('/parcel/letter', 'API\Parcel\OfficerController@currentDayLetterRoom');
        Route::post('/parcel/officer/letter', 'API\Parcel\OfficerController@letter');
        
        Route::resource('/parcel/{room_id}/user', 'API\Parcel\UserController');
        Route::resource('/parcel/officer', 'API\Parcel\OfficerController');

        Route::resource('parcel/backdate', 'API\Parcel\BackDateController');

        Route::post('/parcel/receive/{id}', 'API\Parcel\UserController@receive');
        Route::post('/parcel/code/{id}', 'API\Parcel\UserController@code');
        ...
        Route::group(['prefix'=>'/officer/work','namespace'=>'API\Officer'], function () {
            Route::post('/{task_id}/comment', 'WorkController@commentStore');
            Route::put('/{task_id}/comment/{comment_id}', 'WorkController@commentUpdate');
            Route::delete('/{task_id}/comment/{comment_id}', 'WorkController@commentDelete');
            
            Route::post('/{task_id}/attachment', 'WorkController@attachmentStore');
            Route::delete('/{task_id}/attachment/{attach_id}', 'WorkController@attachmentDelete');


            Route::post('/{task_id}/member/{user_id}', 'WorkController@member');

            Route::put('/{task_id}/status', 'WorkController@status');
            Route::get('/{task_id}/print', 'WorkController@printView');

            Route::post('/{task_id}/category/{category_id}', 'WorkController@category');

            Route::post('/filter', 'WorkController@filter');
        });
        Route::resource('/officer/work', 'API\Officer\WorkController');


        Route::resource('/work/{room_id}/user', 'API\User\WorkController');
        ...
        Route::get('/e-sticker/{print_id}/print', 'API\Officer\EstickerController@printView');
        Route::post('/e-sticker/{room_id}/search', 'API\Officer\EstickerController@search');
        Route::resource('/e-sticker', 'API\Officer\EstickerController');

        Route::resource('/bill', 'API\Bill\BillController');
        Route::post('/bill_user', 'API\Bill\BillController@get_data');
    });
});
