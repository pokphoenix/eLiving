...
class DebtTypeController extends ApiController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    private $route = 'debt_type';
    private $table = 'master_debt_type';
