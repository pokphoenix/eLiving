...
class WorkJobTypeController extends ApiController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    private $variable = 'work_job_type';
    private $table = 'master_work_job_type';
    ...
    {
        $data[$this->variable]  = WorkJobType::all();
    ...
    public function destroy(Request $request, $domainId, $id)
    {
        ...
        $post = $request->except('api_token', '_method');
        $query = WorkJobType::find($id)->delete();
        return $this->respondWithItem(['id'=>$id]);
    }
