...
class WorkSystemTypeController extends ApiController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    private $variable = 'work_system_type';
    private $table = 'master_work_system_type';
    ...
    {
        $data[$this->variable]  = WorkSystemType::all();
    ...
    public function store(Request $request, $domainId)
    {
        ...
        $query = WorkSystemType::create($post);
    ...
    {
        $data['data']  = WorkSystemType::find($id);
        return $this->respondWithItem($data);
    }
    ...
    public function destroy(Request $request, $domainId, $id)
    {
        ...
        $post = $request->except('api_token', '_method');
        $query = WorkSystemType::find($id)->delete();
        return $this->respondWithItem(['id'=>$id]);
    }
