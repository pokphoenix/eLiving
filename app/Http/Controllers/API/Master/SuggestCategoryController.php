...
class SuggestCategoryController extends ApiController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    private $variable = 'suggest_category';
    private $table = 'master_suggest_category';
    ...
    {
        $data[$this->variable]  = SuggestCategory::all();
    ...
    public function store(Request $request, $domainId)
    {
        ...
        $query = SuggestCategory::create($post);
    ...
    {
        $data['data']  = SuggestCategory::find($id);
        return $this->respondWithItem($data);
    }
    ...
    public function destroy(Request $request, $domainId, $id)
    {
        ...
        $post = $request->except('api_token', '_method');
        $query = SuggestCategory::find($id)->delete();
        return $this->respondWithItem(['id'=>$id]);
    }
