...
class ChannelTypeController extends ApiController
{
    ...
    */
    ...
    private $variable = 'channel_type';
    private $table = 'master_channel_type';
    ...
    {
        $data[$this->variable]  = ChannelType::all();
    ...
    public function destroy(Request $request, $domainId, $id)
    {
        ...
        $post = $request->except('api_token', '_method');
        $query = ChannelType::find($id)->delete();
        return $this->respondWithItem(['id'=>$id]);
    }
    ...
    private function validator($request)
    {
        switch ($request->method()) {
            ...
            case 'PUT':
                ...
                $validate =  [
                    'name' => 'required|string|max:255|unique:'.$this->table.',name,'.$id,
                ];
            case 'PATCH':
            default:
                break;
