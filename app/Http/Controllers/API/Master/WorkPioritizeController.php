...
class WorkPioritizeController extends ApiController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    private $variable = 'work_pioritize';
    private $table = 'master_work_prioritize';
    ...
    {
        $data[$this->variable]  = WorkPioritize::all();
    ...
    public function store(Request $request, $domainId)
    {
        ...
        $query = WorkPioritize::create($post);
    ...
    {
        $data['data']  = WorkPioritize::find($id);
        return $this->respondWithItem($data);
    }
    ...
    public function destroy(Request $request, $domainId, $id)
    {
        ...
        $post = $request->except('api_token', '_method');
        $query = WorkPioritize::find($id)->delete();
        return $this->respondWithItem(['id'=>$id]);
    }
