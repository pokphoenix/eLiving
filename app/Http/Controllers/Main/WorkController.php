...
class WorkController extends Controller
{
    ...
    public function index($domainId)
    {
        ...
        $prioritizes = $json['response']['master_prioritize'] ;
        $taskMember = $json['response']['member_officer'] ;
        return view($this->view.'.index', compact('title', 'route', 'domainId', 'domainName', 'tasks', 'statusHistory', 'taskCategory', 'taskMember', 'taskDone', 'prioritizes'));
    }
    ...
    public function show(Request $request, $domainId, $taskId)
    {
        ...
        return view($this->view.'.index', compact('title', 'route', 'domainId', 'domainName', 'tasks', 'taskId', 'taskCategory', 'taskMember', 'taskDone', 'prioritizes'));
    }
