...
class EstickerReasonController extends Controller
{
    private $route = 'master/esticker-reason' ;
    private $title  ;
    private $view = 'master.title_name' ;

    public function __construct()
    {
        $this->title = App::isLocale('en') ? 'Esticker Reason' : 'ประเภทสาเหตุการออกสติ๊กเกอร์' ;
    }
    /**
    ...
    public function index(Request $request, $domainId)
    {
        ...
        $lists = $json['response']['esticker_reason'] ;
