...
class WordWhiteListController extends Controller
{
    private $route = 'master/word-whitelist' ;
    private $title  ;
    private $view = 'master.blacklist' ;
    private $variable = 'word_whitelist' ;

    public function __construct()
    {
        $this->title = App::isLocale('en') ? 'Word Whitelist' : 'คำอนุญาติใช้' ;
    }
    /**
