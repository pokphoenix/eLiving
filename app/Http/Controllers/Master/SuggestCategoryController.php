...
class SuggestCategoryController extends Controller
{
    private $route = 'master/suggest-category' ;
    private $title  ;
    private $view = 'master.system_type' ;
    private $variable = 'suggest_category' ;

    public function __construct()
    {
        $this->title = App::isLocale('en') ? 'Suggest Category' : 'ประเภทคำแนะนำสำหรับระบบ' ;
    }
    /**
